			...
			<div id="header-wrap" class="border-top border-f5">
				<div class="container">
					<div class="header-row justify-content-between flex-row-reverse flex-lg-row top-search-parent">
						...
						<nav class="primary-menu">
							...
							<ul class="menu-container">
								<li class="menu-item sub-menu">
									<a class="menu-link" href="index.html"><div>Home<i class="icon-angle-down"></i></div></a>
									<ul class="sub-menu-container" style="">
										...
										<li class="menu-item sub-menu" style="">
											<a class="menu-link" href="index-portfolio.html"><div>Home - Portfolio<i class="icon-angle-down"></i></div></a>
											<ul class="sub-menu-container" style="">
												<li class="menu-item" style="">
										...
										<button class="sub-menu-trigger icon-chevron-right"></button></li>
										<li class="menu-item sub-menu" style="">
											<a class="menu-link" href="index-blog.html"><div>Home - Blog<i class="icon-angle-down"></i></div></a>
											<ul class="sub-menu-container" style="">
												<li class="menu-item" style="">
										...
										<button class="sub-menu-trigger icon-chevron-right"></button></li>
										<li class="menu-item sub-menu" style="">
											<a class="menu-link" href="index-shop.html"><div>Home - Shop<i class="icon-angle-down"></i></div></a>
											<ul class="sub-menu-container" style="">
												<li class="menu-item" style="">
										...
										<button class="sub-menu-trigger icon-chevron-right"></button></li>
										<li class="menu-item sub-menu" style="">
											<a class="menu-link" href="index-magazine.html"><div>Home - Magazine<i class="icon-angle-down"></i></div></a>
											<ul class="sub-menu-container" style="">
												<li class="menu-item" style="">
										...
										<button class="sub-menu-trigger icon-chevron-right"></button></li>
										<li class="menu-item sub-menu" style="">
											<a class="menu-link" href="landing.html"><div>Home - Landing Page<i class="icon-angle-down"></i></div></a>
											<ul class="sub-menu-container" style="">
												<li class="menu-item" style="">
										...
										<button class="sub-menu-trigger icon-chevron-right"></button></li>
										<li class="menu-item sub-menu" style="">
											<a class="menu-link" href="index-fullscreen-image.html"><div>Home - Full Screen<i class="icon-angle-down"></i></div></a>
											<ul class="sub-menu-container" style="">
												<li class="menu-item" style="">
										...
										<button class="sub-menu-trigger icon-chevron-right"></button></li>
										<li class="menu-item sub-menu" style="">
											<a class="menu-link" href="index-onepage.html"><div>Home - One Page<i class="icon-angle-down"></i></div></a>
											<ul class="sub-menu-container" style="">
												<li class="menu-item" style="">
										...
										<button class="sub-menu-trigger icon-chevron-right"></button></li>
										<li class="menu-item mega-menu mega-menu-small sub-menu" style="">
											<a class="menu-link" href="#"><div>Extras<i class="icon-angle-down"></i></div></a>
								...
								<button class="sub-menu-trigger icon-chevron-right"></button></li>
								<li class="menu-item sub-menu">
									<a class="menu-link" href="#"><div>Features<i class="icon-angle-down"></i></div></a>
									<ul class="sub-menu-container" style="">
										<li class="menu-item sub-menu" style="">
											<a class="menu-link" href="#"><div><i class="icon-stack"></i>Sliders<i class="icon-angle-down"></i></div></a>
											<ul class="sub-menu-container" style="">
												<li class="menu-item sub-menu" style="">
													<a class="menu-link" href="slider-revolution.html"><div>Revolution Slider<i class="icon-angle-down"></i></div></a>
													<ul class="sub-menu-container" style="">
														<li class="menu-item" style="">
												...
												<button class="sub-menu-trigger icon-chevron-right"></button></li>
												<li class="menu-item sub-menu" style="">
													<a class="menu-link" href="slider-canvas.html"><div>Canvas Slider<i class="icon-angle-down"></i></div></a>
													<ul class="sub-menu-container" style="">
														<li class="menu-item" style="">
												...
												<button class="sub-menu-trigger icon-chevron-right"></button></li>
												<li class="menu-item sub-menu" style="">
													<a class="menu-link" href="slider-flex.html"><div>Flex Slider<i class="icon-angle-down"></i></div></a>
													<ul class="sub-menu-container" style="">
														<li class="menu-item" style="">
												...
												<button class="sub-menu-trigger icon-chevron-right"></button></li>
												<li class="menu-item sub-menu" style="">
													<a class="menu-link" href="slider-owl.html"><div>Owl Slider<i class="icon-angle-down"></i></div></a>
													<ul class="sub-menu-container" style="">
														<li class="menu-item" style="">
												...
												<button class="sub-menu-trigger icon-chevron-right"></button></li>
												<li class="menu-item sub-menu" style="">
													<a class="menu-link" href="static-parallax.html"><div>Static Media<i class="icon-angle-down"></i></div></a>
													<ul class="sub-menu-container" style="">
														<li class="menu-item" style="">
										...
										<button class="sub-menu-trigger icon-chevron-right"></button></li>
										<li class="menu-item sub-menu" style="">
											<a class="menu-link" href="#"><div><i class="icon-umbrella"></i>Headers<i class="icon-angle-down"></i></div></a>
											<ul class="sub-menu-container" style="">
												<li class="menu-item" style="">
												...
												<li class="menu-item sub-menu" style="">
													<a class="menu-link" href="header-semi-transparent.html"><div>Semi Transparent<i class="icon-angle-down"></i></div></a>
													<ul class="sub-menu-container" style="">
														<li class="menu-item" style="">
												...
												<button class="sub-menu-trigger icon-chevron-right"></button></li>
												<li class="menu-item sub-menu" style="">
													<a class="menu-link" href="header-side-left.html"><div>Left Side Header<i class="icon-angle-down"></i></div></a>
													<ul class="sub-menu-container" style="">
														<li class="menu-item" style="">
												...
												<button class="sub-menu-trigger icon-chevron-right"></button></li>
												<li class="menu-item sub-menu" style="">
													<a class="menu-link" href="header-side-right.html"><div>Right Side Header<i class="icon-angle-down"></i></div></a>
													<ul class="sub-menu-container" style="">
														<li class="menu-item" style="">
										...
										<button class="sub-menu-trigger icon-chevron-right"></button></li>
										<li class="menu-item mega-menu mega-menu-small sub-menu" style="">
											<a class="menu-link" href="#"><div><i class="icon-align-justify2"></i>Menu Styles<i class="icon-angle-down"></i></div></a>
											<div class="mega-menu-content" style="">
												<div class="row mx-0" style="">
													<ul class="sub-menu-container mega-menu-column col" style="">
														<li class="menu-item" style="">
										...
										<button class="sub-menu-trigger icon-chevron-right"></button></li>
										<li class="menu-item sub-menu" style="">
											<a class="menu-link" href="mega-menu.html"><div><i class="icon-line-columns"></i>Mega Menu<i class="icon-angle-down"></i></div></a>
											<ul class="sub-menu-container" style="">
												<li class="menu-item" style="">
										...
										<li class="menu-item mega-menu mega-menu-small sub-menu" style="">
											<a class="menu-link" href="widgets.html"><div><i class="icon-gift"></i>Widgets<i class="icon-angle-down"></i></div></a>
											<div class="mega-menu-content" style="">
												<div class="row mx-0" style="">
													<ul class="sub-menu-container mega-menu-column col" style="">
														<li class="menu-item" style="">
										...
										<button class="sub-menu-trigger icon-chevron-right"></button></li>
										<li class="menu-item mega-menu mega-menu-small sub-menu" style="">
											<a class="menu-link" href="#"><div><i class="icon-ok-sign"></i>Page Titles<i class="icon-angle-down"></i></div></a>
											<div class="mega-menu-content" style="">
												<div class="row mx-0" style="">
													<ul class="sub-menu-container mega-menu-column col-5" style="">
														<li class="menu-item" style="">
													...
													<ul class="sub-menu-container mega-menu-column col-7" style="">
														<li class="menu-item" style="">
										...
										<button class="sub-menu-trigger icon-chevron-right"></button></li>
										<li class="menu-item sub-menu" style="">
											<a class="menu-link" href="side-panel.html"><div><i class="icon-line-layout"></i>Side Panel<i class="icon-angle-down"></i></div></a>
											<ul class="sub-menu-container" style="">
												<li class="menu-item" style="">
										...
										<button class="sub-menu-trigger icon-chevron-right"></button></li>
										<li class="menu-item sub-menu" style="">
											<a class="menu-link" href="modal-onload.html"><div><i class="icon-line-expand"></i>Modal OnLoad<i class="icon-angle-down"></i></div></a>
											<ul class="sub-menu-container" style="">
												<li class="menu-item" style="">
										...
										<button class="sub-menu-trigger icon-chevron-right"></button></li>
										<li class="menu-item mega-menu mega-menu-small sub-menu" style="">
											<a class="menu-link" href="#footer" data-scrollto="#footer"><div><i class="icon-th"></i>Footers<i class="icon-angle-down"></i></div></a>
											<div class="mega-menu-content" style="">
												<div class="row mx-0" style="">
													<ul class="sub-menu-container mega-menu-column col" style="">
														<li class="menu-item" style="">
								...
								<li class="menu-item mega-menu sub-menu">
									<a class="menu-link" href="#"><div>Pages<i class="icon-angle-down"></i></div></a>
									<div class="mega-menu-content mega-menu-style-2" style="width: 1116px;">
											...
											<div class="row">
												<ul class="sub-menu-container mega-menu-column col-lg-3" style="">
													<li class="menu-item mega-menu-title sub-menu" style="">
														...
														<ul class="sub-menu-container" style="">
															<li class="menu-item sub-menu" style="">
																<a class="menu-link" href="about.html"><div>About Us<i class="icon-angle-down"></i></div></a>
																<ul class="sub-menu-container mega-menu-dropdown" style="">
																	<li class="menu-item" style="">
															...
															<button class="sub-menu-trigger icon-chevron-right"></button></li>
															<li class="menu-item sub-menu" style="">
																<a class="menu-link" href="gdpr.html"><div>GDPR Compliance<i class="icon-angle-down"></i></div></a>
																<ul class="sub-menu-container mega-menu-dropdown" style="">
																	<li class="menu-item" style="">
												...
												<ul class="sub-menu-container mega-menu-column col-lg-3" style="">
													<li class="menu-item mega-menu-title sub-menu" style="">
														...
														<ul class="sub-menu-container" style="">
															<li class="menu-item sub-menu" style="">
																<a class="menu-link" href="services.html"><div><i class="icon-star-of-life"></i>Services Pages<i class="icon-angle-down"></i></div></a>
																<ul class="sub-menu-container mega-menu-dropdown" style="">
																	<li class="menu-item" style="">
															...
															<button class="sub-menu-trigger icon-chevron-right"></button></li>
															<li class="menu-item sub-menu" style="">
																<a class="menu-link" href="#"><div><i class="icon-calendar3"></i>Events<i class="icon-angle-down"></i></div></a>
																<ul class="sub-menu-container mega-menu-dropdown" style="">
																	<li class="menu-item sub-menu" style="">
																		<a class="menu-link" href="events-list.html"><div>Events List<i class="icon-angle-down"></i></div></a>
																		<ul class="sub-menu-container mega-menu-dropdown" style="">
																			<li class="menu-item" style="">
																	...
																	<button class="sub-menu-trigger icon-chevron-right"></button></li>
																	<li class="menu-item sub-menu" style="">
																		<a class="menu-link" href="event-single.html"><div>Single Event<i class="icon-angle-down"></i></div></a>
																		<ul class="sub-menu-container mega-menu-dropdown" style="">
																			<li class="menu-item" style="">
																	...
																	<button class="sub-menu-trigger icon-chevron-right"></button></li>
																	<li class="menu-item sub-menu" style="">
																		<a class="menu-link" href="event-single-full-width-image.html"><div>Single Event - Full<i class="icon-angle-down"></i></div></a>
																		<ul class="sub-menu-container mega-menu-dropdown" style="">
																			<li class="menu-item" style="">
															...
															<button class="sub-menu-trigger icon-chevron-right"></button></li>
															<li class="menu-item sub-menu" style="">
																<a class="menu-link" href="contact.html"><div><i class="icon-envelope"></i>Contact Pages<i class="icon-angle-down"></i></div></a>
																<ul class="sub-menu-container mega-menu-dropdown" style="">
																	<li class="menu-item" style="">
															...
															<button class="sub-menu-trigger icon-chevron-right"></button></li>
															<li class="menu-item sub-menu" style="">
																<a class="menu-link" href="faqs.html"><div><i class="icon-question-circle"></i>FAQs Pages<i class="icon-angle-down"></i></div></a>
																<ul class="sub-menu-container mega-menu-dropdown" style="">
																	<li class="menu-item" style="">
												...
												<ul class="sub-menu-container mega-menu-column col-lg-3" style="">
													<li class="menu-item mega-menu-title sub-menu" style="">
														...
														<ul class="sub-menu-container" style="">
															<li class="menu-item sub-menu" style="">
																<a class="menu-link" href="full-width.html"><div>Full Width<i class="icon-angle-down"></i></div></a>
																<ul class="sub-menu-container mega-menu-dropdown" style="">
																	<li class="menu-item" style="">
															...
															<button class="sub-menu-trigger icon-chevron-right"></button></li>
															<li class="menu-item sub-menu" style="">
																<a class="menu-link" href="#"><div>Sidebars<i class="icon-angle-down"></i></div></a>
																<ul class="sub-menu-container mega-menu-dropdown" style="">
																	<li class="menu-item" style="">
												...
												<ul class="sub-menu-container mega-menu-column col-lg-3" style="">
													<li class="menu-item mega-menu-title sub-menu" style="">
														...
														<ul class="sub-menu-container" style="">
															<li class="menu-item sub-menu" style="">
																<a class="menu-link" href="login-register.html"><div>Login/Register<i class="icon-angle-down"></i></div></a>
																<ul class="sub-menu-container mega-menu-dropdown menu-pos-invert" style="">
																	<li class="menu-item" style="">
															...
															<button class="sub-menu-trigger icon-chevron-right"></button></li>
															<li class="menu-item sub-menu" style="">
																<a class="menu-link" href="coming-soon.html"><div>Coming Soon<i class="icon-angle-down"></i></div></a>
																<ul class="sub-menu-container mega-menu-dropdown menu-pos-invert" style="">
																	<li class="menu-item" style="">
															...
															<button class="sub-menu-trigger icon-chevron-right"></button></li>
															<li class="menu-item sub-menu" style="">
																<a class="menu-link" href="404.html"><div>404 Pages<i class="icon-angle-down"></i></div></a>
																<ul class="sub-menu-container mega-menu-dropdown menu-pos-invert" style="">
																	<li class="menu-item" style="">
								...
								<button class="sub-menu-trigger icon-chevron-right"></button></li>
								<li class="menu-item mega-menu sub-menu">
									<a class="menu-link" href="#"><div>Portfolio<i class="icon-angle-down"></i></div></a>
									<div class="mega-menu-content mega-menu-style-2" style="width: 1116px;">
										<div class="container" style="">
											<div class="row">
												<ul class="sub-menu-container mega-menu-column col" style="">
								...
								<button class="sub-menu-trigger icon-chevron-right"></button></li>
								<li class="menu-item mega-menu sub-menu">
									<a class="menu-link" href="#"><div>Blog<i class="icon-angle-down"></i></div></a>
									<div class="mega-menu-content mega-menu-style-2" style="width: 1116px;">
										<div class="container" style="">
											<div class="row">
												<ul class="sub-menu-container mega-menu-column col-lg-3" style="">
								...
								<button class="sub-menu-trigger icon-chevron-right"></button></li>
								<li class="menu-item sub-menu">
									<a class="menu-link" href="shop.html"><div>Shop<i class="icon-angle-down"></i></div></a>
									<ul class="sub-menu-container" style="">
										<li class="menu-item" style="">
											<a class="menu-link" href="shop.html"><div>4 Columns</div></a>
										</li>
										<li class="menu-item sub-menu" style="">
											<a class="menu-link" href="shop-3.html"><div>3 Columns<i class="icon-angle-down"></i></div></a>
											<ul class="sub-menu-container" style="">
												<li class="menu-item" style="">
										...
										<button class="sub-menu-trigger icon-chevron-right"></button></li>
										<li class="menu-item sub-menu" style="">
											<a class="menu-link" href="shop-2.html"><div>2 Columns<i class="icon-angle-down"></i></div></a>
											<ul class="sub-menu-container" style="">
												<li class="menu-item" style="">
										...
										<button class="sub-menu-trigger icon-chevron-right"></button></li>
										<li class="menu-item sub-menu" style="">
											<a class="menu-link" href="shop-1.html"><div>1 Columns<i class="icon-angle-down"></i></div></a>
											<ul class="sub-menu-container" style="">
												<li class="menu-item" style="">
										...
										<li class="menu-item sub-menu" style="">
											<a class="menu-link" href="shop-single.html"><div>Single Product<i class="icon-angle-down"></i></div></a>
											<ul class="sub-menu-container" style="">
												<li class="menu-item" style="">
								...
								<button class="sub-menu-trigger icon-chevron-right"></button></li>
								<li class="menu-item mega-menu sub-menu">
									<a class="menu-link" href="#"><div>Shortcodes<i class="icon-angle-down"></i></div></a>
									<div class="mega-menu-content" style="width: 1116px;">
										<div class="container" style="">
											<div class="row">
												<ul class="sub-menu-container mega-menu-column col" style="">
													<li class="menu-item" style="">
						...
						<form class="top-search-form" action="search.html" method="get" style="width: 1116px;">
